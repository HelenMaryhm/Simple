...
public class CreateDatabaseClient {
    ...
    private void createDatabaseAdminClient(){
        ...
        String databaseName = "mmuttappashurpal-db";

        SpannerOptions spannerOptions = SpannerOptions.newBuilder().setCredentials(GcloudAuthenticate.getCredentials()).setProjectId(projectId).build();
