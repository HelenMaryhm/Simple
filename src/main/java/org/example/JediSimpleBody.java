...
public class JediSimpleBody {

    public static void main(String[] args) {
        String boundary = "--Boundary_3_738260980_1720685625900";
        String data = """
        ...
        ArrayList<String[]> parsedParts = parseMultipartData(data, boundary);
        for (String[] part : parsedParts) {
            //System.out.println("Header: " + part[0]);
            //System.out.println("Body: " + part[1]);
            if (validateJsonPart(part[1])) {
                //System.out.println("Valid JSON part.");
            }
        }
        System.out.println("Total parts: " + parsedParts.size());
        System.out.println("Parts: " + parsedParts);
    }

    private static ArrayList<String[]> parseMultipartData(String data, String boundary) {
        ArrayList<String[]> parsedParts = new ArrayList<>();
    ...
    private static boolean validateJsonPart(String jsonPart) {
        try {
