...
cmd=$(curl -s -v -H --location 'http://localhost:8080/cmdg/v1/sid/77/mbox/message/?appid=test&ymreqid=860DD108-3A23-4B25-8670-0D22C6D02376' \
                        ...
                        --form 'MULTI_PART_MAIN_BODY=@/Users/hmaryt/Documents/TYJ/jedi/apps/qa/qa_common/src/main/resources/com/yahoo/mail/qa/messages/msgWithTnefWithAttachments.msg;type=application/octet-stream' \
                        --form "MULTI_PART_HEADER=$json_data;type=application/json")


echo "$cmd" | json_pp

# apps/qa/qa_common/src/main/resources/com/yahoo/mail/qa/messages/msgWithTnefWithAttachments.msg