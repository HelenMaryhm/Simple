...
cmd=$(curl -s -v -H --location 'http://localhost:8080/cmdg/v1/migration/sid/77/mbox/message/updateMessagesByYmumid?appid=testAppId&ymreqid=651d52bf-abf1-fd97-50fa-6483ce7be81d' \
