...
cmd=$(curl -s -v -H --location 'http://localhost:8080/cmdg/v1/sid/77/mbox/message/ymumid/1/mime/structure/inline?appid=test&ymreqid=860DD108-3A23-4B25-8670-0D22C6D02376' \
