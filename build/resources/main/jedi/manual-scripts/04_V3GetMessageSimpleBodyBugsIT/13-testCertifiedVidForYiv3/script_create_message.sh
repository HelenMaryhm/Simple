...
cmd=$(curl -s -v -H --location 'http://localhost:8080/cmdg/v1/sid/777/mbox/message/?appid=test&ymreqid=860DD108-3A23-4B25-8670-0D22C6D02376' \
                        ...
                        --form 'MULTI_PART_MAIN_BODY=@/Users/hmaryt/Documents/TYY/ML/Simple/src/main/resources/jedi/manual-scripts/04_V3GetMessageSimpleBodyBugsIT/13-testCertifiedVidForYiv3/testCertifiedVidForYiv3.msg;type=application/octet-stream' \
